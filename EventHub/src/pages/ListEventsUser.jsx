...
export const ListEventsUser = () => {
    ...
    const fetchEvents = async()=>{
        setLoading(true)
        await axios.get(URL+"events-by-user/"+user.id)
        .then((res)=>{
            setEvents(res.data);
        })
    ...
    const removeDelete = async (event) => {
        setLoading(true)
    ...
    <div>
        ...
        <div className="mb-4">
            ...
            <div className="flex justify-end">
                <button className="px-4 py-2 rounded-md bg-sky-500 text-sky-100 hover:bg-sky-600">Créer un événement</button>
            </div>
        </div>
        <div className="flex flex-col">
            ...
            <div className="inline-block min-w-full overflow-hidden align-middle border-b border-gray-200 shadow sm:rounded-lg">
                ...
                {events.map((event)=>
                    ...
                    <td className="text-sm font-medium leading-5 text-center whitespace-no-wrap border-b border-gray-200 ">
                        <button onClick={()=>removeDelete(event)} className="text-gray-600 hover:text-gray-900">
